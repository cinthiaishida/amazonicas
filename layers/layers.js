...
lyr__1.set('fieldAliases', {'Língua': 'Língua', 'Família': 'Família', 'Título': 'Título', 'Apresentad': 'Apresentad', 'Latitude': 'Latitude', 'Longitude': 'Longitude', });
lyr__1.set('fieldImages', {'Língua': 'TextEdit', 'Família': 'TextEdit', 'Título': 'TextEdit', 'Apresentad': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', });
lyr__1.set('fieldLabels', {'Língua': 'inline label - visible with data', 'Família': 'inline label - visible with data', 'Título': 'inline label - visible with data', 'Apresentad': 'inline label - visible with data', 'Latitude': 'hidden field', 'Longitude': 'hidden field', });
